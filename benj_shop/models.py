...
import uuid #makes a unique id ofr our data (primary key)

#instantiate all our classes
db = SQLAlchemy() #make database object
login_manager = LoginManager() #makes login object

#user login_manager object to create a user_loader function
...
#this of these as admin (keeping track of what products are available to sell)
class User(db.Model, UserMixin): 
    ...
    date_added = db.Column(db.DateTime, default=datetime.utcnow)#grab a timestamp as soon as a User object is insantiated 
    ...
    def set_id(self):
        return str(uuid.uuid4()) #this is creating a unique id token
